...
if direct == True:
    ...
    run_type = input('Run Type is (\'r\' for real. \'s\' for simulation): ')
...
((chi,chistddv),(choi,choistddv)) = an.fit_tomodata(tomo_data, tomo_set, B_chi, B_choi, n, fit_method,stddv=True)
